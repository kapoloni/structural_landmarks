...
if __name__ == "__main__":
    ...
    input_image_path = "/databases/data1_study1/AD/MRI/Katia/" + \
                       "IXI/brain_extraction/"
    input_mask = "/databases/data1_study1/AD/MRI/Katia/IXI/mesh/r8/"
    output_path = "output"
    ...
    path_in, path_mask, path_out = utils.get_directories_mask(input_image_path,
                                                              input_mask,
                                                              pc_folder)
    path_in = [pt+".nii.gz" for pt in path_in]
    path_mask = [pt+"_LH.nii.gz" for pt in path_mask]
    ...
    utils.probabilistic_atlas_landmarks(output_age_path,
                                        utils.get_input_paths_atlas(
                                            output_age_path,
                                            ["Guys", "HH", "IOP"],
                                            "../../atlas_test/sorted",
                                            atlas_samples_prefix),
