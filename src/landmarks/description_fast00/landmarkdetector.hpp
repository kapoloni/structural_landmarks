...
public:
    ...
    landmark_detector(std::string filename_prefix,
                      ...
                      unsigned char options = OPTION_GET_SALIENCIES_MAP +
...
public:
    ...
    static const unsigned char OPTION_NONE = 0;
     ...
     /** {brief-description} **/
    static const unsigned char OPTION_GET_SALIENCIES_MAP = 1;

     /** {brief-description} **/
    static const unsigned char OPTION_GET_LOCAL_DESCRIPTORS = 2;
