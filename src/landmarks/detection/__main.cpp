...
int main(int argc, char *argv[])
{
    ...
    if (cmdline.HasSwitch("-fp"))
      filename_detected_points   = cmdline.GetArgument("-fp", 0);
    std::cout << filename_detected_points << "\n";
    ...
    bip::landmark_detector detector(filename_io_prefix, sizes, itk_ref_img, input_mask,
